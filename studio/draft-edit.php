...
$get = $_GET['topic'];
$Sci_con=$conn->prepare("SELECT * FROM draft WHERE id=? order by id DESC LIMIT 1");
...
<div class="d-flex w-100"> 
  <textarea id="page_topic" class="topico p-3 m-2 fw-bold" > <?php echo $Sci_topic;
    ?></textarea>
...
<button class="btn text-dark btn-primary bg-success text-white w-100 fw-bold"  style=" border-bottom-left-radius: 30px; height:100%;border: none; border-bottom-right-radius: 30px;" onclick="Publish_edito()">Edit Draft</button>
...
let e =  2;
if (d == e) {
$("#datadiv").html('<strong style="color:green;">Editing Draft......</strong>'); 
...
$space_nav_loader('draftss.php','sign');
