...
@font-face {
  ...
  src: url(fonts/<?php  echo $font_family; ?>.TTF);
}
...
*{
   ...
   if ($font_size == 1) {
//     small
echo "  font-size: 90%; font-family: ".$font_family.";";
  }
  else if ($font_size == 2) {
//     medium
echo "  font-size: 100%; font-family: ".$font_family.";";
  }  else if ($font_size == 3) {
//     large
echo "  font-size: 105%; font-family: ".$font_family.";";
  }
