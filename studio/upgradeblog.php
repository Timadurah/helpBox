...
<div class="bg-light" style=" position: relative; border-radius: 30px; border: 1px solid rgb(240, 232, 232);">
   ...
   <div class="justify-content-center m-3 Sci_editor py-3"  contenteditable="true"  id="Sci_editor"><p>Hello World ...</p>
   </div>  
...
<div class="align-items-center" style="border-top: 8px solid white;">
<div class="d-flex w-100"> 
  <textarea id="page_topic" class="topico p-3 m-2 fw-bold" >Page Topic....  </textarea>
...
<!-- add Sepo description -->



<div class="align-items-center" style="border-top: 8px solid white;">
<div class="d-flex w-100"> 
  <textarea id="page_desc" class="topico p-3 m-2 fw-bold" >Seo descrption will goes here..  </textarea>
</div>
</div>
...
$cate = $key['category_name'];


?>
    <div class="p-2 border mx-1 fw-bold rounded" >
    
        <input type="radio" name="cat" value="<?php echo $cate; ?>" class="mx-2" style="cursor: pointer;" onclick="catput('<?php echo $cate; ?>')" >
      <?php echo $cate; ?>
...
<div  class="d-flex align-items-center " style="height:50px;">           
 <button class="bg-twist btn btn-primary w-100 fw-bold text-white"  style="height: 100%; border-bottom-left-radius: 30px;  border: none;" 
 onclick="Publish_D()"> Save as Draft </button> 

<button class="btn text-dark btn-primary bg-white w-100 fw-bold"  style="height:100%;border: none; border-bottom-right-radius: 30px;" onclick="Publish_p()">Publish</button>
...
let page_topic = $('#page_topic').val();
let page_desc = $('#page_desc').val();
let page_content = $('#Sci_editor').html();
let banner = $("#Sci_editor img:first").attr("src");
...
$space_nav_loader('upgradeblog.php','sign');
...
const catdata = $('#catdata').val();
const page_topic = $('#page_topic').val();
const page_content = $('#Sci_editor').html();
const banner = $("#Sci_editor img:first").attr("src");
...
const ee =  2;
if (dd == ee) {
$("#datadiv").html('<strong style="color:green;">Saving as Draft......</strong>'); 
